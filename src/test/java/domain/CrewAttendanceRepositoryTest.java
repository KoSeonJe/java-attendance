...
class CrewAttendanceRepositoryTest {
    ...
    void 출석을_저장한다() {
        ...
        // then
        CrewAttendance savedCrewAttendance = crewAttendanceRepository.findByCrew(crew);
    ...
    void 출석을_찾는다() {
        ...
        // when
        CrewAttendance foundCrewAttendance = crewAttendanceRepository.findByCrew(crew);
    ...
    void 존재하지_않는_크루는_찾지_못한다() {
        ...
        // when & then
        Assertions.assertThatThrownBy(() -> crewAttendanceRepository.findByCrew(new Crew("이름")))
